 ...
 */
public class ExpandableSelectedItemAdapter extends AbstractExpandableItemAdapter<ExpandableSelectedItemAdapter.MyGroupViewHolder, ExpandableSelectedItemAdapter.MyChildViewHolder> {

    private UnityDataProvider unityDataProvider;

    public ExpandableSelectedItemAdapter(UnityDataProvider unityDataProvider) {
    ...
    public int getGroupCount() {
        return unityDataProvider.getSelectedGroupCount() + 1;
    }
    ...
    public int getChildCount(int groupPosition) {
        if (groupPosition == 0)
            return 0;
        return unityDataProvider.getSelectedChildCount(groupPosition - 1);
    }
    ...
    public long getGroupId(int groupPosition) {
        ...
        return unityDataProvider.getSelectedGroupItem(groupPosition - 1).getGroupId();
    }
    ...
    public long getChildId(int groupPosition, int childPosition) {
        ...
        return unityDataProvider.getSelectedChildItem(groupPosition - 1, childPosition).getChildId();
    }
    ...
    public void onBindGroupViewHolder(MyGroupViewHolder holder, int groupPosition, int viewType) {
        ...
        // child item
        final AbstractExpandableDataProvider.BaseData item = unityDataProvider.getSelectedGroupItem(groupPosition - 1);
...
//            holder.mContainer.setCardBackgroundColor(Color.rgb(224,224,224));
    ...
    public void onBindChildViewHolder(final MyChildViewHolder holder, final int groupPosition, final int childPosition, int viewType) {
        if (groupPosition == 0)
            return;
        // group item
        final UnityDataProvider.ConcreteChildData childItem = unityDataProvider.getSelectedChildItem(groupPosition - 1, childPosition);
