...
import cmu.cconfs.instantMessage.db.InviteMessgeDao;
import cmu.cconfs.instantMessage.db.UserDao;
import cmu.cconfs.instantMessage.domain.InviteMessage;
import cmu.cconfs.instantMessage.domain.InviteMessage.InviteMesageStatus;
...
public class IMMainActivity extends IMBaseActivity implements EMEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        //异步获取当前用户的昵称和头像
        ((IMHXSDKHelper) HXSDKHelper.getInstance()).getUserProfileManager().asyncGetCurrentUserInfo();
    }
...
//					unreadAddressLable.setText(String.valueOf(count));
    ...
    public int getUnreadAddressCountTotal() {
        ...
        if (((IMHXSDKHelper)HXSDKHelper.getInstance()).getContactList().get(Constant.NEW_FRIENDS_USERNAME) != null)
            unreadAddressCountTotal = ((IMHXSDKHelper)HXSDKHelper.getInstance()).getContactList().get(Constant.NEW_FRIENDS_USERNAME)
                    .getUnreadMsgCount();
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactAdded(List<String> usernameList) {
            // 保存增加的联系人
            Map<String, User> localUsers = ((IMHXSDKHelper)HXSDKHelper.getInstance()).getContactList();
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (ChatActivity.activityInstance != null
                        ...
                        Toast.makeText(IMMainActivity.this, ChatActivity.activityInstance.getToChatUsername() + st10, 1)
                                .show();
    ...
    private void saveInviteMsg(InviteMessage msg) {
        ...
        // 未读数加1
        User user = ((IMHXSDKHelper)HXSDKHelper.getInstance()).getContactList().get(Constant.NEW_FRIENDS_USERNAME);
    ...
    private void showConflictDialog() {
        ...
        IMHXSDKHelper.getInstance().logout(false,null);
        ...
        if (!IMMainActivity.this.isFinishing()) {
            ...
            try {
                if (accountRemovedBuilder == null)
                    accountRemovedBuilder = new android.app.AlertDialog.Builder(IMMainActivity.this);
