...
public class UserProfileActivity extends IMBaseActivity implements OnClickListener {
	...
	public void asyncFetchUserInfo(String username){
		((IMHXSDKHelper) HXSDKHelper.getInstance()).getUserProfileManager().asyncGetUserInfo(username, new EMValueCallBack<User>() {
	...
	private void updateRemoteNick(final String nickName) {
		...
		new Thread(new Runnable() {
			...
			@Override
			public void run() {
				boolean updatenick = ((IMHXSDKHelper)HXSDKHelper.getInstance()).getUserProfileManager().updateParseNickName(nickName);
	...
	private void uploadUserAvatar(final byte[] data) {
		...
		new Thread(new Runnable() {
			...
			@Override
			public void run() {
				final String avatarUrl = ((IMHXSDKHelper)HXSDKHelper.getInstance()).getUserProfileManager().uploadUserAvatar(data);
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
						dialog.dismiss();
