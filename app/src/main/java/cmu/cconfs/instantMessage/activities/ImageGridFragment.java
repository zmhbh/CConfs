...
import cmu.cconfs.BuildConfig;
import cmu.cconfs.R;
import cmu.cconfs.instantMessage.domain.VideoEntity;
import cmu.cconfs.instantMessage.util.ImageCache;
import cmu.cconfs.instantMessage.util.ImageResizer;
import cmu.cconfs.instantMessage.util.Utils;
import cmu.cconfs.instantMessage.widget.RecyclingImageView;
