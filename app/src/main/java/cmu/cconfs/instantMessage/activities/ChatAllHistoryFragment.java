...
import cmu.cconfs.instantMessage.adapter.ChatAllHistoryAdapter;
...
public class ChatAllHistoryFragment extends Fragment implements View.OnClickListener {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (username.equals(CConfsApplication.getInstance().getUserName()))
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		// 更新消息未读数
		((IMMainActivity) getActivity()).updateUnreadLabel();
	...
	public void onResume() {
		super.onResume();
		if (!hidden && ! ((IMMainActivity)getActivity()).isConflict) {
			refresh();
		}
	}
