...
import cmu.cconfs.instantMessage.adapter.ContactAdapter;
...
import cmu.cconfs.instantMessage.widget.Sidebar;
...
public class ContactlistFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		((IMHXSDKHelper)HXSDKHelper.getInstance()).getUserProfileManager().addSyncContactInfoListener(contactInfoSyncListener);
		...
		new Thread(new Runnable() {
			public void run() {
				try {
					...
					((IMHXSDKHelper)HXSDKHelper.getInstance()).getContactList().remove(tobeDeleteUser.getUsername());
					getActivity().runOnUiThread(new Runnable() {
						public void run() {
							pd.dismiss();
	...
	public void onDestroy() {
		...
		if(contactInfoSyncListener != null){
			((IMHXSDKHelper)HXSDKHelper.getInstance()).getUserProfileManager().removeSyncContactInfoListener(contactInfoSyncListener);
		}
		super.onDestroy();
	}
	...
	private void getContactList() {
		contactList.clear();
		//获取本地好友列表
		Map<String, User> users = ((IMHXSDKHelper)HXSDKHelper.getInstance()).getContactList();
