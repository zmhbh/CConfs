...
public class LoginActivity extends IMBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (CConfsApplication.getInstance().getUserName() != null) {
			usernameEditText.setText(CConfsApplication.getInstance().getUserName());
		}
	}
	...
	public void login(View view) {
		...
		EMChatManager.getInstance().login(currentUsername, currentPassword, new EMCallBack() {
			...
			public void onSuccess() {
				...
				// 登陆成功，保存用户名密码
				CConfsApplication.getInstance().setUserName(currentUsername);
				CConfsApplication.getInstance().setPassword(currentPassword);
