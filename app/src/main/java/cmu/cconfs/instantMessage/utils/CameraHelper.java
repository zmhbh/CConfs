 ...
 */
package cmu.cconfs.instantMessage.utils;
...
//            yuv_Rotate90lr = new byte[mwidth * mheight * bitsperpixel / 8];
    ...
    boolean isScreenOriatationPortrait() {
        return CConfsApplication.applicationContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
}
