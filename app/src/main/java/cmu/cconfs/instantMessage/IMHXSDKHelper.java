 ...
 */
package cmu.cconfs.instantMessage;
...
import cmu.cconfs.R;
import cmu.cconfs.instantMessage.activities.ChatActivity;
import cmu.cconfs.instantMessage.activities.IMMainActivity;
import cmu.cconfs.instantMessage.activities.VideoCallActivity;
import cmu.cconfs.instantMessage.activities.VoiceCallActivity;
import cmu.cconfs.instantMessage.domain.RobotUser;
import cmu.cconfs.instantMessage.domain.User;
import cmu.cconfs.instantMessage.imlib.controller.HXSDKHelper;
import cmu.cconfs.instantMessage.imlib.model.HXNotifier;
import cmu.cconfs.instantMessage.imlib.model.HXNotifier.HXNotificationInfoProvider;
import cmu.cconfs.instantMessage.imlib.model.HXSDKModel;
import cmu.cconfs.instantMessage.receiver.CallReceiver;
import cmu.cconfs.instantMessage.utils.CommonUtils;
 ...
 *
 */
public class IMHXSDKHelper extends HXSDKHelper {

    private static final String TAG = "IMHXSDKHelper";
    ...
    protected HXSDKModel createModel() {
        return new IMHXSDKModel(appContext);
    }
        ...
        return new HXNotifier(){
            public synchronized void onNewMsg(final EMMessage message) {
                ...
                if (message.getChatType() == ChatType.Chat) {
                    ...
                    notNotifyIds = ((IMHXSDKModel) hxModel).getDisabledGroups();
                } else {
                    chatUsename = message.getTo();
                    notNotifyIds = ((IMHXSDKModel) hxModel).getDisabledIds();
                }
    ...
    public Map<String, User> getContactList() {
        if (getHXId() != null && contactList == null) {
            contactList = ((IMHXSDKModel) getModel()).getContactList();
        }
	...
	public Map<String, RobotUser> getRobotList() {
		if (getHXId() != null && robotList == null) {
			robotList = ((IMHXSDKModel) getModel()).getRobotList();
		}
		return robotList;
	}
    ...
    public void saveContact(User user){
    	...
    	((IMHXSDKModel) getModel()).saveContact(user);
    }
    ...
    public void updateContactList(List<User> contactInfoList) {
        ...
        ((IMHXSDKModel)getModel()).saveContactList(mList);
    }
