 ...
 */
package cmu.cconfs.instantMessage.adapter;
...
import cmu.cconfs.instantMessage.activities.BaiduMapActivity;
import cmu.cconfs.instantMessage.activities.ChatActivity;
import cmu.cconfs.instantMessage.activities.ContextMenu;
import cmu.cconfs.instantMessage.activities.ShowBigImage;
import cmu.cconfs.instantMessage.activities.ShowNormalFileActivity;
import cmu.cconfs.instantMessage.activities.ShowVideoActivity;
import cmu.cconfs.instantMessage.activities.UserProfileActivity;
import cmu.cconfs.instantMessage.imlib.controller.HXSDKHelper;
import cmu.cconfs.instantMessage.task.LoadImageTask;
import cmu.cconfs.instantMessage.task.LoadVideoImageTask;
import cmu.cconfs.instantMessage.utils.DateUtils;
import cmu.cconfs.instantMessage.utils.ImageCache;
...
public class MessageAdapter extends BaseAdapter {
	...
	public int getItemViewType(int position) {
		...
		if (message.getType() == EMMessage.Type.TXT) {
			...
			else if(((IMHXSDKHelper) HXSDKHelper.getInstance()).isRobotMenuMessage(message))
